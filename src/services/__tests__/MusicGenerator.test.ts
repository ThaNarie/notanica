...
describe("MusicGenerator", () => {
  describe("getChordsOfType", () => {
    it("should return all major chords in C major scale", () => {
      const majorChords = MusicGenerator.getChordsOfType(
        Key.CMajor,
        ChordType.Major
      );
    ...
    it("should return all minor chords in C major scale", () => {
      const minorChords = MusicGenerator.getChordsOfType(
        Key.CMajor,
        ChordType.Minor
      );
    ...
    it("should return diminished chords in C major scale", () => {
      const dimChords = MusicGenerator.getChordsOfType(
        Key.CMajor,
    ...
    it("should correctly voice chromatic major chords", () => {
      const ebMajorInChord =
        MusicGenerator.CHORD_NOTES[ScaleNote.Eb][ChordType.Major];
      const abMajorInChord =
        MusicGenerator.CHORD_NOTES[ScaleNote.Ab][ChordType.Major];
    ...
    it("should correctly voice chromatic minor chords", () => {
      const cMinorInChord =
        MusicGenerator.CHORD_NOTES[ScaleNote.C][ChordType.Minor];
      const fsMinorInChord =
        MusicGenerator.CHORD_NOTES[ScaleNote.Fs][ChordType.Minor];
    ...
    it("should correctly voice chromatic diminished chords", () => {
      const cDimInChord =
        MusicGenerator.CHORD_NOTES[ScaleNote.C][ChordType.Diminished];
      const gsDimInChord =
        MusicGenerator.CHORD_NOTES[ScaleNote.Gs][ChordType.Diminished];
